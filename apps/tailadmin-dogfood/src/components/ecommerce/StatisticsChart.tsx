...
export default function StatisticsChart() {
  ...
  const options: ApexOptions = {
    ...
    stroke: {
      curve: "straight",
      // Define the line style (straight, smooth, or step)
      ...
      <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        <div className="w-full">
          ...
          <p
            ...
            className="mt-1 text-sm font-normal text-gray-600 xl:bg-slate-50 xl:text-sm xl:font-normal xl:text-gray-700 dark:text-gray-400"
          >
